...
api: POST https://api.airops.com/public_api/agent_apps/{app_uuid}/async_chat
...
<ParamField body="Other properties" type="any" optional/>
</Expandable>
</ParamField>
## Responses
...
<Expandable>
  <ResponseField name="session_id" type="string">
    The session id of the chat. Use the session_id to send a message to an existing conversation.
    If not present, a new session will be created after sending the first message.
  ...
  <ResponseField name="airops_app_execution" type="object" required>
    ...
    <Expandable title="properties">
      ...
      <ResponseField name="conversation_id" type="string | nullable">
      ...
      <ResponseField name="error_message" type="any | nullable">
