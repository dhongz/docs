---
title: "Execute an app synchronously"
description: "Execute an app and get the output immediately. This endpoint executes the app synchronously and returns the result."
api: POST https://api.airops.com/public_api/airops_apps/{app_uuid}/execute
